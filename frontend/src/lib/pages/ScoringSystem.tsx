...
export default function ScoringSystem() {
  const [disease, setDisease]: [DiseaseType, Function] = useState<DiseaseType>(
    DiseaseType.LungCancer
  );
  const [unorderedCodes, setUnorderedCodes]: [string, Function] =
    useState<string>("");
  const [orderedCodes, setOrderedCodes]: [string, Function] =
    useState<string>("");
  ...
  return (
    <div className="pagebody">
      ...
      <ClasifyForm
        disease={disease}
        modelType="Unordered Inputs Model"
        codes={unorderedCodes}
        handleChange={handleUnorderedChange}
        handleClick={handleClassifyButton}
      />
      <ClasifyForm
        disease={disease}
        modelType="Ordered Inputs Model"
        codes={orderedCodes}
        handleChange={handleOrderedChange}
        handleClick={handleClassifyButton}
      />
      <div className="result-link page-content">{message}</div>
